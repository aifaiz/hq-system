<div x-data class="space-y-6 overflow-hidden rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
    ...
    <div class="mt-6 flex items-center gap-2.5">
        ...
        @if($enableOrder == 'YES')
        <button x-on:click="$store.cart.addItem({id:'{{$productid}}',name:'{{$name}}',price: '{{$price}}',qty:1})" type="button" class="inline-flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium  text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
